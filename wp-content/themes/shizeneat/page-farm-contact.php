<?php
/*
Template Name: Farm Contact Page
*/
...
if( $farm_id ) {
    ...
    $farm_email = get_field('farm_email', $farm_id);
    $farm_title = $farm_data->post_title;
?>
    <input type="hidden" name="farm-title" id="farm-title" value="<?php echo $farm_title; ?>">
    <input type="hidden" name="farm-email" id="farm-email" value="<?php echo $farm_email; ?>">
<?php
}
?>
    ...
    <script>
        $(function() {
            ...
            $(window).on("load", function(e) {
                ...
                <?php 
                $farm_id = get_query_var('farm_id') ? (int)get_query_var('farm_id') : 0;
                $farm_email =  $farm_id ? get_field('farm_email', $farm_id) : "";
                ?>
